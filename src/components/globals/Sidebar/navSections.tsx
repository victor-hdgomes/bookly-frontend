...
import { Home, User, FolderOpen, Package, Users, DollarSign, Calendar } from "lucide-react";
  ...
  if (hasCompanies) {
    sections.push({
      ...
      items: [
        ...
        { label: t("appointments"), href: COMPANY_ROUTES.COMPANY_APPOINTMENTS, icon: <Calendar /> },
        { label: t("serviceGroups"), href: COMPANY_ROUTES.COMPANY_SERVICE_GROUPS, icon: <FolderOpen /> },
