...
export const editServiceSchema = (t: (key: string) => string) => z.object({
  ...
  price: z.number().min(0.01, t("validation.priceMinValue")),
  duration: z.number().min(1, t("validation.durationMinValue")),
  discount: z.number().min(0, t("validation.discountMinValue")).max(100, t("validation.discountMaxValue")),
  isActive: z.boolean(),
